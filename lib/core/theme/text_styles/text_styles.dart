...
class FontSizes {
  ...
  static double get titleL => 22 * scale;
  static double get sizeXXl => 28 * scale;
  static double get sizeXXXl => 30 * scale;
}
...
class TextStyles {
  ...
  static TextStyle get titleLarge => TextStyle(fontSize: FontSizes.titleL);
  static TextStyle get h1Style =>
      TextStyle(fontSize: FontSizes.sizeXXl, fontWeight: FontWeight.bold);
  static TextStyle get anouncementStyle =>
      TextStyle(fontSize: FontSizes.sizeXXXl, fontWeight: FontWeight.bold);
  static TextStyle get body =>
      TextStyle(fontSize: FontSizes.body, fontWeight: FontWeight.w300);
  static TextStyle get boldBody =>
      TextStyle(fontSize: FontSizes.body, fontWeight: FontWeight.w500);
